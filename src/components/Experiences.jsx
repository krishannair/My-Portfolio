            ...
            <div className="container">
                ...
                <div className="experience-list">
                    <div className="experience">
                        <img className="experience-cover-image" src={`${process.env.PUBLIC_URL}/images/Turing.avif`} alt="Turing logo" />
                        <div className="layer">
                            <h3>Turing</h3>
                            ...
                            <a href="https://www.turing.com/"><img src={`${process.env.PUBLIC_URL}/images/external-link.svg`} alt="Go to Turing Website"/></a>
                        </div>
                    </div>
                    <div className="experience">
                        <img className="experience-cover-image" src={`${process.env.PUBLIC_URL}/images/HPE.png`} alt="Hewlett Packard Enterprises(HPE) logo"/>
                        <div className="layer">
                            ...
                            <a href="https://github.com/krishannair/AnomalyDetection-MultivariateTimeSeries"><img src={`${process.env.PUBLIC_URL}/images/external-link.svg`} alt="Go to internship project code"/></a>
                        </div>
                    </div>
                    <div className="experience">
                        <img className="experience-cover-image" src={`${process.env.PUBLIC_URL}/images/Marine-Electricals2.png`} alt="Marine-Electricals logo" />
                        <div className="layer">
                            ...
                            <a href="https://drive.google.com/drive/folders/1awl62qygVNmT3F6ve1bdNlIaHBwgi-XP"><img src={`${process.env.PUBLIC_URL}/images/external-link.svg`} alt="Go to internship work drive link"/></a>
                        </div>
                    </div>
                </div>
            </div>
