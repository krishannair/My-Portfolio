            ...
            <div className="container">
                ...
                <div className="project-list">
                    <div className="project">
                        <img className="project-cover-image" src={`${process.env.PUBLIC_URL}/images/TurtleBot.jpeg`} alt="A gazebo training environment for TurtleBot3 Waffle Pi"/>
                        <div className="layer">
                            ...
                            <a href="https://github.com/krishannair/DRL_TurtleBot3"><img src={`${process.env.PUBLIC_URL}/images/external-link.svg`} alt="Go to DRL code page on github."/></a>
                        </div>
                    </div>
                    <div className="project">
                        <img className="project-cover-image" src={`${process.env.PUBLIC_URL}/images/PasswordManager.jpeg`} alt="A screen with encrypted data."/>
                        <div className="layer">
                            ...
                            <a href="https://github.com/krishannair/Password-Manager"><img src={`${process.env.PUBLIC_URL}/images/external-link.svg`} alt="Go to password manager code page on github."/></a>
                        </div>
                    </div>
                    <div className="project">
                        <img className="project-cover-image" src={`${process.env.PUBLIC_URL}/images/SmartTaxi.jpeg`} alt="A taxi avoiding obstacles."/>
                        <div className="layer">
                            ...
                            <a href="https://drive.google.com/drive/folders/1qq-7gXkrfM1Nan8IZJt2b0YnlFS4iMid?usp=drive_link"><img src={`${process.env.PUBLIC_URL}/images/external-link.svg`} alt="Go to drive link of smart taxi project."/></a>
                        </div>
                    </div>
